/*
 * Sort the table:
 * Team with most points in descending order. First tie-breaker is goal difference. Second tie-breaker is goals for. Third tie-breaker is team name alphabetical order
 *
 * @return int
 */
